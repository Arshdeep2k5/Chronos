...
| TEL-1.1 | Local Database Core (SQLite + WAL) | Rust Eng |  |  |  |  | Phase 1 Delivery |
| TEL-1.2 | notify File Ingestion Watcher | Rust Eng |  |  |  |  | Phase 1 Delivery |
| TEL-1.3 | Browser MV3 Extension Telemetry | Rust Eng |  |  |  |  | Phase 1 Delivery |
| TEL-1.4 | VSCode Connector Integration | Rust Eng |  |  |  |  | Phase 1 Delivery |
| **PHASE 2** | **CDE & Risk Analysis** | | | | | | |
| ANA-2.1 | CDE Parser (NLP / Extraction Engine) | Python Eng|  |  |  |  | Phase 2 Delivery |
| ANA-2.2 | Commitment Health Engine (CHE) | Rust Eng |  |  |  |  | Phase 2 Delivery |
| ANA-2.3 | Deadline Failure Forecast & Simulator| Python Eng|  |  |  |  | Phase 2 Delivery |
| ANA-2.4 | Consequence Simulation Engine | Rust Eng |  |  |  |  | Phase 2 Delivery |
